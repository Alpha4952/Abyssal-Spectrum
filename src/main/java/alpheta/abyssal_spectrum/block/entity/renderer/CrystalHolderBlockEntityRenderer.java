...
public class CrystalHolderBlockEntityRenderer implements BlockEntityRenderer<CrystalHolderBlockEntity> {
    public CrystalHolderBlockEntityRenderer(BlockEntityRendererFactory.Context context) {

    }

    @Override
    public void render(CrystalHolderBlockEntity entity, float tickDelta, MatrixStack matrices,
